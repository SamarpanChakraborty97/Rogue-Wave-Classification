...
wave_data_train=data["wave_data_train"][:4000]
wave_data_test=data_test["wave_data_test"]
label_train=data["label_train"][:4000]
label_test=data_test["label_test"]
buoy_mask_train=data["buoy_mask_train"][:4000]
...
edge_file_path = os.getcwd() + f"\edge_data_local_original_node_classification_new_gat.npz"
...
file_str = f"NodeClassification_Local_Originallength_GAT_LSTM"
