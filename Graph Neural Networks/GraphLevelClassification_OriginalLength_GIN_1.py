...
edge_file_path = f"edge_data_15_4_original_num_neighbors_{num_neighbours}.npz"
...
file_str = f"GraphClassification_Originallength_GIN_pre_MLP_dim_{dim_pre_MLP}"
...
### Training and evaluation of the model
model = GraphIsomorphismNetworkWithSkipConnections(dim_pre_MLP, dim_post_MLP, dim_graphLin, num_pre_layers, num_post_layers, dropout_prob, num_graph_layers, training)
train_val_metrics = trainVal(model, train_dataloader)
