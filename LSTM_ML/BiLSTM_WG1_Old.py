...
file_str="tadv_5min_wave_group_window_5mins_1"
...
model_LSTM.add(Bidirectional(LSTM(10, return_sequences=True), input_shape = wave_data_train.shape[1:]))
model_LSTM.add(keras.layers.BatchNormalization())

model_LSTM.add(Bidirectional(LSTM(10, return_sequences=True)))
...
save_name = "accuracy_old_bilstm_wg1"
