...
lines = ['Confusion matrix\n', f"{confusion_matrix}\n", "---------------\n",          f" 'Accuracy:', {metrics.accuracy_score(label_test, label_pred)}\n",         f" 'Precision:', {metrics.precision_score(label_test, label_pred)}\n",         f" 'Recall:', {metrics.recall_score(label_test, label_pred)}",         f" 'F1 Score:', {metrics.f1_score(label_test, label_pred)}\n"]
